...
class BusinessesFactory extends Factory
{
    ...
    public function definition()
    {
        ...
        $list_of_cities=json_decode('[{"country": "PK","name": "Abbottabad","lat": "34.1463","lng": "73.21168" },
                {
                  "country": "PK",
                  "name": "Adilpur",
                  "lat": "27.93677",
       ...
       $list_of_cities= $this->faker->randomElement($list_of_cities);
        return [
            'name' => $fakername,
            'mtitle'=>$this->faker->name,
            'seo_item_meta_title_format'=>'',
            'slug' => Str::slug($fakername,'-'),
            'created_at'=>$this->faker->dateTimeBetween('-7 day' ),
            'description' => $this->faker->text,
            'short_desc' => $this->faker->sentence(3),
            'website' => "https://www.". Str::slug($fakername).".com",
            'country'=>'Pakistan',
            'state'=>$this->faker->randomElement(['Baluchistan','Punjab','Sindh','Khyber Pakhton khawa','Gilgit Baltistan']),
            'type_of_bus'=>$this->faker->randomElement(['African Restaurants',
            ...
            'Content'=>$this->faker->randomElement(['Websites',
                                      'Photos',
                                      'Indian Restaurants',
                                      'Reviews',
                                      'Messaging',
            ...
            'city' =>  $list_of_cities['name'],
            'longitude' =>  $list_of_cities['lng'],
            'latitude' =>  $list_of_cities['lat'],
              ...
              'score' =>rand(1,28000),
              'mon_open_time' =>date('H:i:s', rand(1,28000)),
              'mon_close_time' =>date('H:i:s', rand(54000,249000)),
              'tags' =>implode(",", $this->faker->randomElements([
                  'Fish And Chips', 'Burgers', 'Takeaways', 'Covid Complaint','Perfect Location','Vareity of Food'], 4))
