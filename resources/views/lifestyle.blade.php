	...
	<nav class="navbar navbar-light bg-light">
	  ...
	  <!-- <form class="form-inline" style="display: inline;">
		  <div class="form-group">
		    ...
		    <input type="text" class="form-control" id="inputOne" style="height: 50px;width: 250px" placeholder="Enter a search team">
		  </div>
		  <div class="form-group">
		    <label class="sr-only" for="inputTwo">Location</label>
		    <input type="text" class="form-control" style="height: 50px;width: 250px" id="inputTwo" placeholder="Location">
		  </div>
		  <button type="submit" class="btn btn-default" style="height: 50px;width: 130px;background-color: #d27728">Search</button>
		</form> -->
			...
			<div class="col-lg-12 col-sm-12">
				...
				<div class="Conditions">
					<div class="row">
						<div class="col-md-3">
					      <div class="thumbnail">
					          <img src="{{('pic/pic25.png')}}" width="600" height="400" class="d-inline-block align-top" alt="">
					          <div class="caption">
					            <div class="desc">
					    ...
					    <div class="col-md-3">
					      <div class="thumbnail">
					          <img src="{{('pic/pic26.png')}}" width="600" height="400" class="d-inline-block align-top" alt="">
					          <div class="caption">
					            <div class="desc">
					    ...
					    <div class="col-md-3">
					      <div class="thumbnail">
					          <img src="{{('pic/pic27.png')}}" width="600" height="400" class="d-inline-block align-top" alt="">
					          <div class="caption">
					            <div class="desc">
					    ...
					    <div class="col-md-3">
					      <div class="thumbnail">
					          <img src="{{('pic/pic28.png')}}" width="600" height="400" class="d-inline-block align-top" alt="">
					          <div class="caption">
					            <div class="desc">
			...
			<div class="col-lg-12 col-sm-12">
				...
				<div class="Conditions">
					<div class="row">
						<div class="col-md-3">
						     <div class="thumbnail">
					          <img src="{{('pic/pic29.png')}}" width="600" height="400" class="d-inline-block align-top" alt="">
					          <div class="caption">
					            <div class="desc">
						...
						<div class="col-md-3">
						     <div class="thumbnail">
					          <img src="{{('pic/pic30.png')}}" width="600" height="400" class="d-inline-block align-top" alt="">
					          <div class="caption">
					            <div class="desc">
								  	<h4><b>Grey:</b></h4>
						...
						<div class="col-md-3">
						     <div class="thumbnail">
					          <img src="{{('pic/pic31.png')}}" width="600" height="400" class="d-inline-block align-top" alt="">
					          <div class="caption">
					            <div class="desc">
						...
						<div class="col-md-3">
						     <div class="thumbnail">
					          <img src="{{('pic/pic32.png')}}" width="600" height="400" class="d-inline-block align-top" alt="">
					          <div class="caption">
					            <div class="desc">
		...
		<div class="row">
			<div class="col-lg-12 col-sm-12">
				...
				<ul class="navbar-nav ul" style="position: relative;right: 39px">
			      ...
			      <li class="nav-item li">
			        <a class="nav-link "  style="color: black;" href="{{ url('lifestyle') }}">Sahaa Lifestyle&nbsp;&nbsp; |&nbsp;&nbsp;</a>
			      </li>
			      <li class="nav-item li">
			...
			<div class="col-lg-12 col-sm-12" style="padding-top: 20px">
				...
				<ul class="navbar-nav ul" style="position: relative;right: 39px">
			      <li class="nav-item li" >
			        <a class="nav-link "  style="color: black;" href="{{ url('advertising') }}" >Yell.com Advertising &nbsp;&nbsp;| &nbsp; &nbsp;</a>
			      </li>
			      <li class="nav-item li">
			        <a class="nav-link "  style="color: black;" href="{{ url('smartmoves') }}">Smart Performance&nbsp;&nbsp; | &nbsp;&nbsp;&nbsp;</a>
			      </li>
			      <li class="nav-item li">
