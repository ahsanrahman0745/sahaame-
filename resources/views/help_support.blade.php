...
@section('container')
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 col-sm-6" >
					...
					<button type="button" class="btn btn-lg " style="background-color: #ffd100;">Send Message Now</button>
				</div>
				<div class="col-lg-6 col-sm-6" >
					<img src="{{('pic/pic3.png')}}" width="400px" height="441px" class="d-inline-block align-top" alt="">
				</div>
			</div>
		</div>
	</div>
	<div style="background-color: #0077b5;height: 100px">
		<div class="container" style="position: relative;top: 30px">
			<div class="row">
				<div class="col-lg-4 col-sm-4" style="display: flex;">
					<img src="{{('pic/pic4.png')}}" height="40px" width="40px">
					<p style="color: white;">Text us to Resolve any query</p>
					
				</div>
				<div class="col-lg-4 col-sm-4" style="display: flex;">
					<img src="{{('pic/pic5.png')}}" height="40px" width="40px">
					<p style="color: white;">Get quick comeback </p>
					
				</div>
				<div class="col-lg-4 col-sm-4" style="display: flex;">
					<img src="{{('pic/pic6.png')}}" height="40px" width="40px">
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-3 col-sm-3">
				<div class="guides">
					<a href="" class="guide" data-v-9ae41412><img src="{{('pic/pic7.png')}}" height="40px" width="40px">Accounts</a>
				</div>
			</div>
			<div class="col-lg-3 col-sm-3">
				<div class="guides">
					<a href="" class="guide" data-v-9ae41412><img src="{{('pic/pic7.png')}}" height="40px" width="40px">Products</a>
				</div>
			</div>
			<div class="col-lg-3 col-sm-3">
				<div class="guides">
					<a href="" class="guide" data-v-9ae41412><img src="{{('pic/pic7.png')}}" height="40px" width="40px">Digital Marketing</a>
				</div>
			</div>
			<div class="col-lg-3 col-sm-3">
				<div class="guides">
					<a href="" class="guide" data-v-9ae41412><img src="{{('pic/pic7.png')}}" height="40px" width="40px">Advertising</a>
				</div>
			</div>
			<div class="col-lg-12 col-sm-12">
				<div data-v-9ae41412="" class="supportGuides--heading">Get an Answer to the question that's circling in your head.<br>
				<button type="button" class="btn btn-lg " style="background-color: #ffd100;">Help Center</button>
					...
					<div data-v-9ae41412 class="app--headingCopy-bold app--headingCopy-larger gui">
						<div class="row">
							<div class="col-sm-8 col-sm-8">
								...
								<p style="font-size: 16px;">To manage your Sahaa account and products on the go</p>
								<ul class="ul ">
									<li class="li step" style="float: left;">
										<div style="display: flex; justify-content: space-between;float: left;">
										  <p data-v-6d983f5b=""  style="" class="step--number">1</p>
							...
							<div class="col-sm-4 col-lg-4">
								<img src="{{('pic/pic8.png')}}" height="100%" width="200px">
							</div>
						</div>
					</div>
				</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 col-sm-12">
				<h1>Contacting Sahaa.me</h1>
			</div>
			<div class="row">
				<div class="col-lg-1 col-sm-1">
					
				</div>
				<div class="col-lg-4 col-sm-4" style="border: 1px solid black;height: 250px">
					<center>
					<img src="{{('pic/pic9.png')}}" height="50px" width="30px"><br>
				...
				<div class="col-lg-4 col-sm-4" style="border: 1px solid black;height: 250px">
					<center>
					<img src="{{('pic/pic10.png')}}" height="50px" width="30px"><br>
