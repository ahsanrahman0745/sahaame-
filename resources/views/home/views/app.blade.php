		...
		<div class="row">
			<div class="col-lg-4 col-md-8 col-sm-12" >
				...
				<ul style=" color: white">
					...
					<li style="background-color: white;border: 1px solid silver;padding-left: 5px">
						<a class="s" href="{{ url('app') }}" style="color: #e87503">Can I claim my Business listing on Sahaa Business app?</a>
					</li>

				</ul>
			</div>
			<div class="col-lg-8 col-sm-8">
				<b><h2>Can I claim my Business listing on Sahaa Business app?</h2></b>
				<p style="color:gray;padding-top: 4px;margin-top: -10px" class="p">Last Updated Thu, 11 Nov, 2021 at 12:04 PM</p>
				<div class="row">
					<div class="col-sm-12 col-lg-12">
						<p style="padding-top: 30px;font-size: 14px;">Find your business on the login screen by clicking the ‘Find your Business’ button. You can take control of your business directory on Sahaa.me.<br>
						Your business names and postal codes will be required to find your business. Using the information you've provided, we will look for existing company listings that fit your search criteria or give you the option to add a new listing entirely.
						</p>
					</div>
