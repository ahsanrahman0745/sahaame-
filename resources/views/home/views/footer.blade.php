...
<head>
    ...
    <title>Sahaa.me</title>
    <link rel="stylesheet" href="assets_1/icon/themify-icons.css">
		                            ...
		                            <div class="footer-about-main-links">
		                                <div class="footer-about-main-links-outer">
		                                    <div class="footer-about-main-links-inner">
		                                        ...
		                                        <span class="footer-about0us-link"><a href="{{ url('listing') }}" style="color: #b3adad">Business listings</a></span>
		                                        <span class="side-devider">|</span>
		                                        <span class="footer-about0us-link"><a href="{{ url('help&support') }}" style="color: #b3adad">Help & Support</a></span>
		                                        <span class="side-devider">|</span>
		                                        <span class="footer-about0us-link"><a href="{{ url('sahaa_app') }}" style="color: #b3adad">Sahaa App</a></span>
		                                        <span class="side-devider">|</span>
		                                        <span class="footer-about0us-link"><a href="#" style="color: #b3adad">Sahaa Blogs</a></span>
		                                        <span class="side-devider">|</span>
		                                        <span class="footer-about0us-link"><a href="{{ url('reviews') }}" style="color: #b3adad">Sahaa Reviews</a></span>
		                                    </div>
		                                    <div class="footer-about-main-links-button">
		                                        <a href="mailto:advertise@sahaa.me"><img class="" src="{{('assets_1/images/pic/pic151.PNG')}}" height="" alt="Third slide"></a>
		                            ...
		                            <div class="footer-about-main-links">
		                                <div class="footer-about-main-links-outer">
		                                    <div class="footer-about-main-links-inner">
		                                        ...
		                                        <span class="side-devider">|</span>
		                                        <span class="footer-about0us-link" ><a href="{{ url('advertising') }}" style="color: #b3adad">Adverstsnment</a></span>
		                                        <span class="side-devider">|</span>
		                                        <span class="footer-about0us-link" ><a href="{{ url('smartmoves') }}" style="color: #b3adad">Smart Moves</a></span>
		                                        <span class="side-devider">|</span>
