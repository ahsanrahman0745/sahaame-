	...
	<div class="container">
		<div class="row">
			<div class="col-lg-4 col-md-8 col-sm-12" >
				...
				<ul style=" color: white">
					...
					<li style="background-color: white;border: 1px solid silver;padding-left: 5px">
						<a class="s" href="{{ url('edit') }}" style="color: #e87503">Edit business listing on Sahaa.me</a>
					</li>
					<li style="background-color: white;border: 1px solid silver;padding-left: 5px">
			...
			<div class="col-lg-8 col-sm-8">
				<b><h2>Edit Business Listing on Sahaa.me</h2></b>
				<p style="color:gray;padding-top: 4px;margin-top: -10px" class="p">Last Updated Thu, 11 Nov, 2021 at 12:04 PM</p>
				<div class="row">
					
					<div class="col-sm-12 col-lg-12">
						<p style="padding-top: 30px;font-size: 14px;">With our Web developers, updating your Business listing on Sahaa.me is much easy. We make sure that your business information is always up to date by taking control of your listing content.You can provide us with the updated content for your Sahaa business listing so that our web developer can update your listing with the most up-to-date information about your business. </p>
					</div>
