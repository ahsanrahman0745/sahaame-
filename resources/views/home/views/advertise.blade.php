		...
		<div class="row">
			<div class="col-lg-4 col-md-8 col-sm-12" >
				...
				<ul style=" color: white">
					...
					<li style="background-color: white;border: 1px solid silver;padding-left: 5px">
						<a class="s" href="{{ url('advertise') }}" style="color: #e87503">To Advertise my businesson Sahaa.me, i want a free business listing</a>
					</li>
					<li style="background-color: white;border: 1px solid silver;padding-left: 5px">
			...
			<div class="col-lg-8 col-sm-8">
				<b><h2>To advertise my business on Sahaa.me, I want a free business listing</h2></b>
				<p style="color:gray;padding-top: 4px;margin-top: -10px" class="p">Last Updated Thu, 11 Nov, 2021 at 12:04 PM</p>
				<div class="row">
					<div class="col-sm-12 col-lg-12">
						<p style="padding-top: 30px;font-size: 14px;">Get more clients by creating a free online business profile on Sahaa.me. With our free business listing form, you can get your company listed in the UAE's largest online business directory in just a few minutes.<br></p>
					</div>
