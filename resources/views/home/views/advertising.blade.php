...
@section('container')
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-6 col-sm-6">
				 <img src="{{('assets_1/images/pic/pic12.PNG')}}" width="100%" height="100%" class="d-inline-block align-top" alt="">
			</div>
		</div>
	</div>
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-sm-4 col-sm-4" style="background-color: white">
							<div class="guides" >
								<div data-v-9ae41412 class="app--headingCopy-bold app--headingCopy-larger gui" style="height: ">
									<center><img src="{{('assets_1/images/pic/pic13.PNG')}}" width="100px" height="100px" class="d-inline-block align-top" alt="">
						...
						<div class="col-sm-4 col-sm-4" style="background-color: white">
							<div class="guides" >
								<div data-v-9ae41412 class="app--headingCopy-bold app--headingCopy-larger gui" style="height: ">
									<center><img src="{{('assets_1/images/pic/pic14.PNG')}}" width="100px" height="100px" class="d-inline-block align-top" alt="">
						...
						<div class="col-sm-4 col-sm-4" style="background-color: white">
							<div class="guides" >
								<div data-v-9ae41412 class="app--headingCopy-bold app--headingCopy-larger gui" style="height: ">
									<center><img src="{{('assets_1/images/pic/pic15.PNG')}}" width="100px" height="100px" class="d-inline-block align-top" alt="">
		...
		<div class="row">
			<div class="col-sm-12 col-lg-12">
				...
				<div class="container">
					...
					<img src="{{('assets_1/images/pic/pic16.PNG')}}" width="350px" height="350px" class="d-inline-block align-top" alt="">
				</div>
					...
					<div class="col-sm-6 col-lg-6">
						<div class="row">
							<div class="col-sm-6 col-lg-6">
								<center>
									<br><br><br>
								<img src="{{('assets_1/images/pic/pic17.PNG')}}" width="80px" height="80px" class="d-inline-block align-top" alt="">
								<h2>0800 777 445</h2>
							...
							<div class="col-sm-6 col-lg-6">
								<center>
									<br><br><br>
								<img src="{{('assets_1/images/pic/pic18.PNG')}}" width="80px" height="80px" class="d-inline-block align-top" alt=""><br>
