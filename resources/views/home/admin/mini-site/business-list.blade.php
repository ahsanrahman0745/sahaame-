   ...
   <div class="d-block mb-4 mb-md-0">
      <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
         <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
            ...
            <li class="breadcrumb-item active" aria-current="page">Add Mini Site</li>
         </ol>
      </nav>
      <h2 class="h4">Add Mini Site</h2>
   </div>
</div>
</div>
<!-- All Business Start-->
                    ...
                    <table class="table" id='business-table'>
                        ...
                        <?php foreach($businesses AS $business) { ?>
                            <tr>
                                ...
                                <td><?php echo htmlspecialchars_decode($business->name); ?></td>
                                <td><?php echo htmlspecialchars_decode($business->short_desc); ?></td>
                                <td>
                                    <a href="{{url('admin/mini-site/')}}/<?php echo $business->id; ?>/dashboard" class='btn-sm btn-success'>Add Mini Website</a>
                                </td>
                            </tr>
                        <?php } ?>
                        </tbody>
