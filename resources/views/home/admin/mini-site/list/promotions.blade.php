                    ...
                    <table class="table" id='data-table'>
                        ...
                        <?php foreach($promotions AS $promotion) { ?>
                            <tr>
                                ...
                                <td><img src="{{asset('business/mini-site-resources/promotions')}}/{{$promotion->image}}" alt="" width="100px"></td>
                                <td><?php echo $promotion->title; ?></td>
                                <td><?php echo $promotion->detail; ?></td>
                                <td>
                                    <a href="{{url('admin/mini-site/')}}/<?php echo $promotion->business_id; ?>/promotions/<?php echo $promotion->id?>/edit-form" class='btn-sm btn-primary'>Edit</a>
                                    <a href="{{url('admin/mini-site/')}}/<?php echo $promotion->business_id; ?>/promotions/<?php echo $promotion->id?>/delete" class='btn-sm btn-danger'>Delete</a>
                                </td>
                            </tr>
                        <?php } ?>
                        </tbody>
