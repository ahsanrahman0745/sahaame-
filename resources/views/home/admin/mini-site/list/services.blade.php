                    ...
                    <table class="table" id='data-table'>
                        ...
                        <?php foreach($services AS $service) { ?>
                            <tr>
                                ...
                                <td><img src="{{asset('business/mini-site-resources/services')}}/{{$service->image}}" alt="" width="100px"></td>
                                <td><?php echo $service->title; ?></td>
                                <td><?php echo $service->description; ?></td>
                                <td>
                                    <a href="{{url('admin/mini-site/')}}/<?php echo $service->business_id; ?>/services/<?php echo $service->id?>/edit-form" class='btn-sm btn-primary'>Edit</a>
                                    <a href="{{url('admin/mini-site/')}}/<?php echo $service->business_id; ?>/services/<?php echo $service->id?>/delete" class='btn-sm btn-danger'>Delete</a>
                                </td>
                            </tr>
                        <?php } ?>
                        </tbody>
