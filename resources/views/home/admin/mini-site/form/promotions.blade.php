            ...
            <div class="p-4">
                ...
                <div class="mini-site-form-outer">
                    <div class="mini-site-form-inner">
                        <form action="{{url('/admin/mini-site')}}/{{$business_id}}/promotions/add" method='POST' enctype="multipart/form-data">
                            @csrf
                            <div class="mini-site-form-main">
                                ...
                                <div class="row mt-2">
                                    <div class="col-12">
                                        <textarea name="detail" id="" cols="30" rows="10" class='form-control' placeholder='Enter Promotion Detail' ></textarea>
                                    </div>
                                </div>
                                <hr>
                                <div class="row mt-3">
