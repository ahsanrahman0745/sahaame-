...
<div class="row">
    <div class="col-12">
        <div class="card shadow border-0">
            <div class="p-4">
                <form action="{{url('manage/email-template/add')}}" method='POST'>
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group mt-3">
                                ...
                                <textarea name="body_json" id="rich-textarea-json" class='form-control d-none' cols="30" rows="10"></textarea>
                                <textarea name="body_html" id="rich-textarea-field" class='form-control d-none' cols="30" rows="10"></textarea>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label style='opacity:0'>Title</label>
                                <button class='btn btn-success form-control' >Add Template</button>
                            </div>
                        </div>
                    </div>
                </form>
