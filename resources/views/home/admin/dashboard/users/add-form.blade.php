...
<div class="row">
    <div class="col-12">
        <div class="card shadow border-0">
            <div class="p-4">
                <form action="{{url('dashboard/add/user')}}" method='POST'>
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group mt-2">
                                ...
                                {{genrate_field('first_name')}}
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group mt-2">
                                <label>Last Name</label>
                                {{genrate_field('last_name')}}
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group mt-2">
                                <label>Email</label>
                                <input type="email" name='email' class='form-control' required autocomplete='off' autofill='off'>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group mt-2">
                        ...
                        <div class="col-md-4">
                            <div class="form-group mt-2">
                                ...
                                <input type="password" class='form-control' name='password' required autocomplete='off' autofill='off'>
                            </div>
                        </div>
                        <div class="col-md-12">
