...
<div class="row">
    <div class="col-12">
        <div class="card shadow border-0">
            <div class="p-4">
                <form action="{{url('dashboard/manage/users')}}/{{$user_data->id}}/update" method='POST'>
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group mt-2">
                                ...
                                <input type="text" name='first_name' value='{{$user_data->first_name}}' class='form-control' required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group mt-2">
                                <label>Last Name</label>
                                <input type="text" name='last_name' value='{{$user_data->last_name}}' class='form-control' required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group mt-2">
                                <label>Email</label>
                                <input type="text" name='email' value='{{$user_data->email}}' class='form-control' readonly>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group mt-2">
                                ...
                                <select name="role" id="" class='form-control'>
                                    ...
                                    {{genrate_roles_dropdoen_selected($roles,$user_data->role)}}
                                </select>
                            </div>
                        </div>
                        <div class="col-md-12">
