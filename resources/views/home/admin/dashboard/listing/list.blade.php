                    ...
                    <table class="table table-hover" id='listing-table'>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style='font-size:11px; font-weight:800'>{{$business->name}}</td>
                                <td style='font-size:11px; font-weight:800'>{{$business->email}}</td>
                                <td style='font-size:10px; font-weight:800'>{{get_Category_name($business->pcategories)}} <b>></b><br> {{get_Category_name($business->categories)}} </td>
                                <td style='font-size:11px; font-weight:800'>{{$business->ranking_stars}}</td>
                                <td style='font-size:11px; font-weight:800'>{{convert_date($business->created_at)}}</td>
                                <td style='font-size:11px; font-weight:800'>{{status_text($business->active,$business->spam)}}</td>
                                <td style='font-size:11px; font-weight:800'>
                                @if($permissions->edit_listing !='')
                                    <a href="{{url('manage/listing/')}}/{{$business->id}}/edit-form" class='d-block mt-1 text-center text-primary'>Edit</a>
                                @endif
