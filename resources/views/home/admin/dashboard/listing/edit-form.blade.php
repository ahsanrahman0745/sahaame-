   ...
   <div class="row">
      <div class="col-12 col-xl-12">
         <div class="card card-body border-0 shadow mb-4">
            ...
            <form id="msform" method="POST" action="{{url('manage/listing/')}}/{{$business->id}}/update" enctype="multipart/form-data">
               @csrf
               ...
               <ul id="progressbar">
                  ...
                  <li class='goto-step' id="contact-detail" data-class='.step-2' data-index='1'><strong>Business Contact Details </strong></li>
                  <li class='goto-step' id="business-address" data-class='.step-3' data-index='2'><strong>Business Address</strong></li>
                  <li class='goto-step' id="opening-hours" data-class='.step-4' data-index='3'><strong>Opening Hours</strong></li>
                  <li class='goto-step' id="services" data-class='.step-5' data-index='4'><strong>Services</strong></li>
                  <li class='goto-step' id="seo" data-class='.step-6' data-index='5'><strong>SEO</strong></li>
                  <li class='goto-step' id="owner-detail" data-class='.step-7' data-index='6'><strong>Owner Details (Optional)</strong></li>
                  <li class='goto-step' id="confirm" data-class='.step-8' data-index='7'><strong>Update</strong></li>
               </ul>
               <div class="progress">
                  ...
                  <div class="form-card">
                     ...
                     <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                           ...
                           <input type="text" value="{{$business->short_desc}}" class="form-control" name="short_desc">
                           <label class="fieldlabels">Category :</label>
                           <select class="form-control"  name="pcategories"  id='categories_dropdown'>
                              {{genrate_category_dropdown_selected("parent",$business->pcategories)}}
                           </select>
                           ...
                           <select class="form-control"  name="categories" id='sub-categories'>
                              ...
                              {{genrate_category_dropdown_selected("sub",$business->categories)}}
                           </select>
                           ...
                           <div class="preview-image">
                              <div class="preview-image-outer">
                                 <div class="preview-image-inner">
                                    <img src="{{asset('business/listings/logo')}}/{{$business->logo}}" alt="" id='logo-preview'>
                                 </div>
                              </div>
                           </div>
                           <input type="file" name="logo" accept="image/*" id='logo-image-field'>
                           <input type="hidden" name='logo_default' value="{{$business->logo}}">
                           <label class="fieldlabels">Promotion Banner :</label>
                           <div class="preview-image">
                              <div class="preview-image-outer">
                                 <div class="preview-image-inner">
                                    <img src="{{asset('business/listings/promotion')}}/{{$business->snipshot}}" alt="" id='prommotion-preview'>
                                 </div>
                              </div>
                           </div>
                           <input type="file" name="snipshot" accept="image/*" id='prommotion-image-field'>
                           <input type="hidden" name='snipshot_default' value="{{$business->snipshot}}">
                           <label class="fieldlabels">WebSite:</label>
                           <input type="url" value="{{$business->website}}" class="form-control" name="website">
                           <label class="fieldlabels">Email:</label>
                           <input type="text" value="{{$business->email}}" class="form-control" name="email" id='email-first-field'>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="form-card">
                     ...
                     <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                           ...
                           <input type="tel" value="{{$business->whatsapp}}"
                              class="form-control" name="whatsapp">
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                           <label class="fieldlabels">Messenger us:</label>
                           <input type="text" value="{{$business->phone_text}}"
                              class="form-control" name="phone_text">
                           <label class="fieldlabels">Email Us:</label>
                           <input type="text" value="{{$business->email}}"
                              class="form-control" id='email-second-field'>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="form-card">
                     ...
                     <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                           ...
                           <input type="text" value="{{$business->office}}"
                           ...
                           <input type="text"
                              ...
                              <select class="form-control" name="state" id="states_selection">
                                 <option value="default" hiiden>Choose a City</option>
                                 {{genrate_state_dropdown_selected($business->state)}}
                              </select>
                              <input type="text" name='state_text'  class='d-none' id='state_text' value="{{$business->state_text}}">
                              <label class="fieldlabels">Country :</label>
                              <input type="text" value="{{$business->country}}" class="form-control" name="country">
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                           <label class="fieldlabels">Floor #</label>
                           <input type="text" value="{{$business->floor}}"
                              class="form-control" name="floor">
                           <label class="fieldlabels">Street name:</label>
                           <input type="text" value="{{$business->streetname}}"
                              ...
                              <select class="form-control" name="city" id="area_selection">
                                {{genrate_area_dropdown_selected($business->state,$business->city)}}
                              </select>
                              <input type="text" name='city_text'  class='d-none' id='city_text' value="{{$business->city_text}}">
                        </div>
                     </div>
                  </div>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 ft-row">
                                       <div class="row inner-ft-row">
                                          <div class="col-xs-5 col-sm-5 col-md-4 col-lg-4 day-opened wrap-sel-from"
                                             style="display:block">
                                             <input   type="time" value="{{$business->mon_open_time}}" name="mon_open_time">
                                          </div>
                                          ...
                                          <div class="col-xs-5 col-sm-5 col-md-4 col-lg-4 day-opened wrap-sel-to"
                                             style="display:block">
                                             <input  type="time" value="{{$business->mon_close_time}}" name="mon_close_time">
                                          </div>
                                 ...
                                 <div class="row day-week" data-day="Tuesday">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 ft-row">
                                       <div class="row inner-ft-row">
                                          <div class="col-xs-5 col-sm-5 col-md-4 col-lg-4 day-opened wrap-sel-from"
                                             style="display:block">
                                             <input  type="time" value="{{$business->tue_open_time}}" name="tue_open_time">
                                          </div>
                                          <div class="col-xs-1 col-sm-1 col-md-1 col-lg-1 day-opened"
                                             style="display:block">
                                             <p class="center"><span>-</span></p>
                                          ...
                                          <div class="col-xs-5 col-sm-5 col-md-4 col-lg-4 day-opened wrap-sel-to"
                                             style="display:block">
                                             <input  type="time" value="{{$business->tue_close_time}}" name="tue_close_time">
                                          </div>
                                          <div class="col-xs-1 col-sm-1 col-md-3 col-lg-3 day-opened"
                                             style="display:block">
                                             <div style="display:none"><span
                                 ...
                                 <div class="row day-week" data-day="Wednesday">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 ft-row">
                                       <div class="row inner-ft-row">
                                          <div class="col-xs-5 col-sm-5 col-md-4 col-lg-4 day-opened wrap-sel-from"
                                             style="display:block">
                                             <input  type="time" value="{{$business->wed_open_time}}" name="wed_open_time">
                                          </div>
                                          <div class="col-xs-1 col-sm-1 col-md-1 col-lg-1 day-opened"
                                             style="display:block">
                                             <p class="center"><span>-</span></p>
                                          ...
                                          <div class="col-xs-5 col-sm-5 col-md-4 col-lg-4 day-opened wrap-sel-to"
                                             style="display:block">
                                             <input  type="time" value="{{$business->wed_close_time}}" name="wed_close_time">
                                          </div>
                                          <div class="col-xs-1 col-sm-1 col-md-3 col-lg-3 day-opened"
                                             style="display:block">
                                             <div style="display:none"><span
                                 ...
                                 <div class="row day-week" data-day="Thursday">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 ft-row">
                                       <div class="row inner-ft-row">
                                          <div class="col-xs-5 col-sm-5 col-md-4 col-lg-4 day-opened wrap-sel-from"
                                             style="display:block">
                                             <input  type="time" value="{{$business->thu_open_time}}" name="thu_open_time">
                                          </div>
                                          <div class="col-xs-1 col-sm-1 col-md-1 col-lg-1 day-opened"
                                             style="display:block">
                                             <p class="center"><span>-</span></p>
                                          ...
                                          <div class="col-xs-5 col-sm-5 col-md-4 col-lg-4 day-opened wrap-sel-to"
                                             style="display:block">
                                             <input  type="time" value="{{$business->thu_close_time}}" name="thu_close_time">
                                          </div>
                                          <div class="col-xs-1 col-sm-1 col-md-3 col-lg-3 day-opened"
                                             style="display:block">
                                             <div style="display:none"><span
                                 ...
                                 <div class="row day-week" data-day="Friday">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 ft-row">
                                       <div class="row inner-ft-row">
                                          <div class="col-xs-5 col-sm-5 col-md-4 col-lg-4 day-opened wrap-sel-from"
                                             style="display:block">
                                             <input  type="time" value="{{$business->fri_open_time}}" name="fri_open_time">
                                          </div>
                                          <div class="col-xs-1 col-sm-1 col-md-1 col-lg-1 day-opened"
                                             style="display:block">
                                             <p class="center"><span>-</span></p>
                                          ...
                                          <div class="col-xs-5 col-sm-5 col-md-4 col-lg-4 day-opened wrap-sel-to"
                                             style="display:block">
                                             <input  type="time" value="{{$business->fri_close_time}}" name="fri_close_time">
                                          </div>
                                          <div class="col-xs-1 col-sm-1 col-md-3 col-lg-3 day-opened"
                                             style="display:block">
                                             <div style="display:none"><span
                                 ...
                                 <div class="row day-week" data-day="Saturday">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 ft-row">
                                       <div class="row inner-ft-row">
                                          <div class="col-xs-5 col-sm-5 col-md-4 col-lg-4 day-opened wrap-sel-from"
                                             style="display:block">
                                             <input  type="time" value="{{$business->sat_open_time}}" name="sat_open_time">
                                          </div>
                                          <div class="col-xs-1 col-sm-1 col-md-1 col-lg-1 day-opened"
                                             style="display:block">
                                             <p class="center"><span>-</span></p>
                                          ...
                                          <div class="col-xs-5 col-sm-5 col-md-4 col-lg-4 day-opened wrap-sel-to"
                                             style="display:block">
                                             <input  type="time" value="{{$business->sat_close_time}}" name="sat_close_time">
                                          </div>
                                          <div class="col-xs-1 col-sm-1 col-md-3 col-lg-3 day-opened"
                                             style="display:block">
                                             <div style="display:none"><span
                                 ...
                                 <div class="row day-week" data-day="Sunday">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 ft-row">
                                       <div class="row inner-ft-row">
                                          <div class="col-xs-5 col-sm-5 col-md-4 col-lg-4 day-opened wrap-sel-from"
                                             style="display:block">
                                             <input  type="time" value="{{$business->sun_open_time}}" name="sun_open_time">
                                          </div>
                                          <div class="col-xs-1 col-sm-1 col-md-1 col-lg-1 day-opened"
                                             style="display:block">
                                             <p class="center"><span>-</span></p>
                                          ...
                                          <div class="col-xs-5 col-sm-5 col-md-4 col-lg-4 day-opened wrap-sel-to"
                                             style="display:block">
                                             <input  type="time" value="{{$business->sun_close_time}}" name="sun_close_time">
                                          </div>
                                          <div class="col-xs-1 col-sm-1 col-md-3 col-lg-3 day-opened"
                                             style="display: none">
                                             <div style="display:none"><span
                     ...
                     <div class="row">
                                         ...
                                         <div class="seo-preview-main">
                                             ...
                                             <div class="seo-preview-box">
                                                 <div class="seo-preview-title">
                                                    {{$business->mtitle}} | Sahaa.me
                                                 </div>
                                                 <div class="seo-preview-link">
                                                    <a href="{{$business->seo_link}}" target="_blank" id='seo-link-a'>{{$business->seo_link}}</a>
                                                 </div>
                         ...
                         <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                             <div class="form-group">
                                 ...
                                 <input type="text" value="{{$business->mtitle}}" class="form-control meta-title-input" name="mtitle" id="meta-title" maxlength="51">
                                 <input type="hidden" name='meta_title_slug' id='meta_title_slug' value="{{$business->meta_title_slug}}">
                                 <input type="hidden" name='seo_link' id='seo_link-input' value="{{$business->seo_link}}">
                             </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                             <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                           <div class="form-group">
                              ...
                              <textarea name="meta_desc" rows="4"
                                 cols="30" class='meta-description-input' maxlength="251">{{$business->meta_desc}}</textarea>
                           </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                           <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <select name="security_question_slug" id="security_question_slug" class='form-control'>
                                    ...
                                    <option value="born_city" <?php get_selected_text('born_city',$business->security_question_slug) ?>>In what city were you born?</option>
                                    <option value="fav_pet" <?php get_selected_text('fav_pet',$business->security_question_slug) ?>>What is the name of your favorite pet?</option>
                                    <option value="maiden_name" <?php get_selected_text('maiden_name',$business->security_question_slug) ?>>What is your mother's maiden name?</option>
                                    <option value="high_school" <?php get_selected_text('high_school',$business->security_question_slug) ?>>What high school did you attend?</option>
                                    <option value="firts_school" <?php get_selected_text('firts_school',$business->security_question_slug) ?>>What is the name of your first school?</option>
                                    <option value="first_car" <?php get_selected_text('first_car',$business->security_question_slug) ?>>What was the make of your first car?</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <label>Answer:</label>
                                <textarea name="security_answer" id="" class='form-control' cols="30" rows="11">{{$business->security_answer}}</textarea>
                            </div>
                        </div>
                     </div>
                  </div>
