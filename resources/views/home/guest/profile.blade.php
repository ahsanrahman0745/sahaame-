                                                ...
                                                <div class="guest-user-profile-content-setion-title">
                                                    <div class="guest-user-profile-content-setion-title-outer">
                                                        ...
                                                        @if(session()->has('access_error'))
                                                            <div class="alert alert-danger mt-2 text-danger text-center" id='success-message'>{{ session()->get('access_error') }}</div>
                                                        @endif
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="guest-user-profile-content-setion-main-content-inner">
                                                            <div class="guest-user-profile-content-single-section">
                                                                <div class="guest-user-profile-content-single-section-outer">
                                                                    ...
                                                                    <div class="guest-user-profile-content-single-section-description">
                                                                        This is where you can add and change your profile information, including <br> your name, description and password.
                                                                    </div>
                                                                    <div class="guest-user-profile-update-profile-section">
                                                                        <div class="guest-user-profile-update-profile-section-outer">
                                                                            <form action="{{url('guest/profile/update')}}" method='POST'>
                                                                                ...
                                                                                <div class="guest-user-profile-update-profile-section-inner">
                                                                                    <div class="guest-user-profile-update-profile-box">
                                                                                        <div class="guest-user-profile-update-profile-fields">
                                                                                            <div class="guest-user-profile-update-profile-section-field">
                                                                                                <label>First name</label>
                                                                                                <input type="text" class='field' name='first_name' value='{{$guest_data->first_name}}'>
                                                                                            </div>
                                                                                            <div class="guest-user-profile-update-profile-section-field">
                                                                                                <label>Last name</label>
                                                                                                <input type="text" class='field' name='last_name' value='{{$guest_data->last_name}}'>
                                                                                            </div>
                                                                                        </div>
                                                            ...
                                                            <div class="guest-user-profile-content-single-section" id='login-setting'>
                                                                <div class="guest-user-profile-content-single-section-outer">
                                                                    <div class="guest-user-profile-content-single-section-title">
                                                                        Log in settings
                                                                    </div>
                                                                    @if(session()->has('password_error'))
                                                                        <div class="alert alert-danger mt-2 text-danger text-center" id='success-message'>{{ session()->get('password_error') }}</div>
                                                                    @endif
                                                                    <div class="guest-user-profile-update-profile-section">
                                                                        <div class="guest-user-profile-update-profile-section-outer">
                                                                            <form action="{{url('guest/profile/update')}}" method='post'>
                                                                                <input type="hidden" name='update_login' value='true'>
                                                                                @csrf
                                                                                <div class="guest-user-profile-update-profile-section-inner">
                                                                                    <div class="guest-user-profile-update-profile-box">
                                                                                        <div class="guest-user-profile-update-profile-fields">
                                                                                        ...
                                                                                        <div class="guest-user-profile-update-profile-fields">
                                                                                            ...
                                                                                            <div class="guest-user-profile-update-profile-section-field">
                                                                                                ...
                                                                                                <input type="password" class='field' name='confirm_password' required>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="guest-user-profile-update-profile-save-button">
                                                                                            <button>Save Changes</button>
                                                                    ...
                                                                    <div class="guest-user-profile-update-profile-section">
                                                                        <div class="guest-user-profile-update-profile-section-outer">
                                                                            <form action="{{url('#')}}">
                                                                                <div class="guest-user-profile-update-profile-section-inner">
                                                                                    <div class="guest-user-profile-update-profile-box">
                                                                                        <div class="guest-user-profile-update-profile-section-field-check">
                                                                                            <label>
                                                                                                <input type="checkbox"> Email me when there is activity on my review
                                                                                            </label>
                                                                                        </div>
                                                                                        <div class="guest-user-profile-update-profile-section-field-check">
                                                                                            <label>
                                                                                                <input type="checkbox"> I would like to receive news & offers from Sahaa.me
                                                                                            </label>
                                                                                        </div>
                                                                                        <div class="guest-user-profile-update-profile-save-button">
                                                                                            <button>Save Changes</button>
