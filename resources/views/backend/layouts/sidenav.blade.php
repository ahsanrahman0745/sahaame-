<?php
$permissions = Session::get('user_role');
?>
<nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" data-simplebar>
   <div class="sidebar-inner px-2 pt-3">
      ...
      <ul class="nav flex-column pt-3 pt-md-0">
         ...
         @if(isset($permissions[0]->manage_user))
         <li class="nav-item">
         ...
         @endif
         @if(isset($permissions[0]->manage_role))
         <li class="nav-item">
            <span class="nav-link collapsed d-flex justify-content-between align-items-center"
         ...
         @endif
         @if(isset($permissions[0]->manage_listing))
         <li class="nav-item">
            <span class="nav-link collapsed d-flex justify-content-between align-items-center"
         ...
         @endif
         @if(isset($permissions[0]->track_activity))
         <li class="nav-item">
            <span
            ...
            <div class="multi-level collapse" role="list" id="submenu-listings" aria-expanded="false">
               <ul class="flex-column nav">
                  <li class="nav-item {{ Request::segment(1) == 'managelisting' ? 'active' : '' }}">
                     <a href="{{url('manage/listing/list')}}" class="nav-link">
                        <span class="sidebar-text">Listing </span>
                     </a>
                  </li>
                  <li class="nav-item {{ Request::segment(1) == 'managelisting' ? 'active' : '' }}">
                     <a href="{{url('manage/listing/recheck')}}" class="nav-link">
                        <span class="sidebar-text">Recheck </span>
                     </a>
                  </li>
                  @if(isset($permissions[0]->manage_ranking))
...
{{--                     <a href="/managemedia" class="nav-link">--}}
                     <a href="{{url('/manage/listingmedia')}}" class="nav-link">
         ...
         @endif
         @if(isset($permissions[0]->manage_mini_site))
         <li class="nav-item">
         ...
         @endif
         @if(isset($permissions[0]->manage_email_templates))
         <li class="nav-item">
            <span class="nav-link d-flex justify-content-between align-items-center collapsed" data-bs-toggle="collapse" data-bs-target="#email-template" aria-expanded="false">
               ...
               <div class="multi-level collapse" role="list" id="email-template" aria-expanded="false">
                  <ul class="flex-column nav">
                     @if(isset($permissions[0]->add_listing))
                     <li class="nav-item ">
         ...
         @if(isset($permissions[0]->manage_contact_details))
         <li class="nav-item">
        ...
        <li class="nav-item">
            <a href="{{url('dashboard/business-request/list')}}" class="nav-link d-flex align-items-center">
                <span class="sidebar-icon"><i class="fa fa-phone me-2"></i></span>
                <span class="mt-1 ms-1 sidebar-text">
                    Business Requests
                </span>
