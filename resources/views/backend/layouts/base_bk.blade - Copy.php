...
<head>
    ...
    <link href="/backend/asserts/css/bs5/bootstrap.min.css" rel="stylesheet">
    <!-- Datepicker -->
    <link rel="stylesheet" href="/vendor/vanillajs-datepicker/dist/css/datepicker.min.css">
    <link rel="stylesheet"
        href="/vendor/vanillajs-datepicker/dist/css/datepicker-bs4.min.css">
...
<script src="https://cdn.jsdelivr.net/gh/livewire/sortable@v0.x.x/dist/livewire-sortable.js"></script>
    ...
    <!-- zafar -->
<script
  src="/vendor/jquery-3.4.1.js"></script>
{{-- <link href="https://cdn.jsdelivr.net/npm/select2@4.0.12/dist/css/select2.min.css" rel="stylesheet" /> --}}
<link href="/assets/css/select2.min.css" rel="stylesheet" />
{{-- <script src="https://cdn.jsdelivr.net/npm/select2@4.0.12/dist/js/select2.min.js"></script> --}}
<script src="/assets/js/select2.js"></script>
   <script src="/assets/js/script_select2.js"></script>
        <script>
      if (typeof jQuery != 'undefined') {  
    // jQuery is loaded => print the version
    console.log(jQuery.fn.jquery);
}
      jQuery("#multiplekeyword").select2({
              tags: true,
    multiple: true,
      });
    </script>
