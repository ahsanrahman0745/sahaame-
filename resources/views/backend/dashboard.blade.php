...
<div class="row">
            ...
            <div class="card-body">
                <div class="row d-block d-xl-flex align-items-center">
                    <div
                        ...
                        <div class="d-sm-none">
                            <h2 class="h5">Total Number of Listing </h2>
                            <h3 class="fw-extrabold mb-1">345,678</h3>
                        </div>
                    </div>
                    <div class="col-12 col-xl-7 px-xl-0">
                        <div class="d-none d-sm-block">
                            <h2 class="h6 text-gray-400 mb-0">Total Listing</h2>
            ...
            <div class="card-body">
                <div class="row d-block d-xl-flex align-items-center">
                    <div
                        ...
                        <div class="d-sm-none">
                            <h2 class="fw-extrabold h5">Listing according to category </h2>
                    ...
                    <div class="col-12 col-xl-7 px-xl-0">
                        <div class="d-none d-sm-block">
                            <h2 class="h6 text-gray-400 mb-0">Listing according to category </h2>
    ...
    <div class="col-12 col-sm-6 col-xl-4 mb-2">
            ...
            <div class="card-body">
                <div class="row d-block d-xl-flex align-items-center">
                    <div
                        ...
                        <div class="d-sm-none">
                            <h2 class="fw-extrabold h5">User according to star </h2>
                            <h3 class="mb-1">50.88%</h3>
                        </div>
                    </div>
                    <div class="col-12 col-xl-7 px-xl-0">
                        <div class="d-none d-sm-block">
                            <h2 class="h6 text-gray-400 mb-0">User according to star </h2>
        ...
        <div class="col-12 col-sm-6 col-xl-4 mb-2">
        <div class="card border-0 shadow">
            <div class="card-body" style="height: 332px; overflow-y: scroll;">  
                <div class="row d-block d-xl-flex align-items-center">
          <div>
                <div class="container">
  <div class="row">
    <div class="col-12">
      <h6 class="text-muted">Listings by category</h6> 
      <ul class="list-group">
      @php
    //  var_dump($cat_array);
      @endphp
    ...
    //  var_dump($cat['child']);
      @endphp
        ...
        @if(count($cat['child']))
         ...
         @foreach($cat['child'] as $subc)
          <li class="list-group-item d-flex pl-2 justify-content-between align-items-center"><span style="padding-left:30px">{{$subc['name']}}</span> <span class="badge badge-primary badge-pill">{{$subc['count']}}</span></li>
          @endforeach
            ...
            <div class="card-body">
                <div class="row d-block d-xl-flex align-items-center">
                    <div
                        ...
                        <div class="d-sm-none">
                            <h2 class="fw-extrabold h5">Total Number of reviews </h2>
                            <h3 class="mb-1">50.88%</h3>
                        </div>
                    </div>
                    <div class="col-12 col-xl-7 px-xl-0">
                        <div class="d-none d-sm-block">
                            <h2 class="h6 text-gray-400 mb-0">Total Number of reviews </h2>
                            <h3 class="fw-extrabold mb-2">50.88%</h3>
                        </div>
                        <small class="text-gray-500">
                            Feb 1 - Apr 1
            ...
            <div class="card-body">
                <div class="row d-block d-xl-flex align-items-center">
                    <div
                        ...
                        <div class="d-sm-none">
                            <h2 class="fw-extrabold h5"> Total Number of suggestion’s </h2>
                            <h3 class="mb-1">50.88%</h3>
                        </div>
                    </div>
                    <div class="col-12 col-xl-7 px-xl-0">
                        <div class="d-none d-sm-block">
                            <h2 class="h6 text-gray-400 mb-0"> Total Number of suggestion’s </h2>
                            <h3 class="fw-extrabold mb-2">50.88%</h3>
                        </div>
                        <small class="text-gray-500">
                            Feb 1 - Apr 1
            ...
            <div class="card-body">
                <div class="row d-block d-xl-flex align-items-center">
                    <div
                        ...
                        <div class="d-sm-none">
                            <h2 class="fw-extrabold h5">Reported Listing </h2>
                            <h3 class="mb-1">50.88%</h3>
                        </div>
                    </div>
                    <div class="col-12 col-xl-7 px-xl-0">
                        <div class="d-none d-sm-block">
                            <h2 class="h6 text-gray-400 mb-0">Reported Listing </h2>
                            <h3 class="fw-extrabold mb-2">50.88%</h3>
                        </div>
                        <small class="text-gray-500">
                            Feb 1 - Apr 1
