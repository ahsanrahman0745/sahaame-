<div>
          <form wire:submit.prevent="register" action="#" class="mt-4">
                            <!-- Form -->
                            <div class="form-group mb-4">
                                <label for="email">Your Name</label>
                                <div class="input-group">
                                   
                                    <input wire:model="name" type="text" class="form-control" id="name" autofocus required>
                                </div>  
                            </div>
                            <div class="form-group mb-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input wire:model.lazy="passwordConfirmation" type="password" type= placeholder="Confirm Password" class="form-control" id="confirm_password" required>
                                    </div>  
                                </div>
                                <!-- End of Form -->
