                     ...
                     <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                           ...
                           <select class="form-control"  name="categories" >
                              ...
                              <option value="{{ $sub->id }}" {{(isset($data->categories) and $data->categories== $sub->id) ?  'selected'  : '' }}>{{ $sub->name }}</option>
                              @endforeach
                           </select>
                     ...
                     <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                           ...
                           <select class="form-control" name="state" id="">
                              ...
                              <option value="{{ $state->state }}" {{(isset($data->state) and $data->state== $state->state) ?  'selected'  : '' }}>{{ $state->state }}</option>
                              @endforeach
                           </select>
