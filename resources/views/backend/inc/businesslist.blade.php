...
@endphp
                                @if($lists->starts)
<div class="rating-wapper star{{$c}}" style="width:calc(30% + {{$c}}0%)">
<ul>
@for($i=1;$i<=$c; $i++)
<li><img src="assets/icons/star.png" height="18" alt=""></li>

@endfor
</ul>
<span>Supplier rank</span>
</div>
 @endif
   ...
   @if($lists->logo)
                     ...
                     {{ substr($lists->name,0,1) }}
                      ...
                      <div class="charaterpic">{{ substr($lists->name,0,1) }}</div>
                            ...
                            <div class="single-search-main-info-div-inner">
                                <div class="single-search-main-info-div-main">
                                    <div class="single-search-main-info-title">
                                        ...
                                        {{ $lists->name }} @if($lists->varified==1 or $lists->starts==3)
                                    ...
                                    <div class="single-search-main-info-cate-title">
                                        ...
                                        <div class="single-search-main-info-right-side-text color-blue">
                                           @php 
                                            $cid=(int)$lists->pcategories;
                                            if($cid>0){
                                           echo $all_cat[$cid]['name'];
                                            }
                                          //  var_dump();
                                            @endphp
                                        </div>
                                    ...
                                    <div class="all-share-buttons">
                                        ...
                                        @if($lists->whatsapp)
                                            ...
                                            <a href="mailto:{{ $lists->email}}" class="button-icon"
                                               ...
                                               @endif
                                            @if($lists->phone_text)
                                            <a href="http://m.me/{{ $lists->phone_text}}" class="button-icon"
                                                style="margin-right: 5px;">
