		...
		<div class="col-lg-9 col-md-9 col-sm-12  mobile-order-01 mobile-margin-bottom" style="">
			<div class="container" style="height: 100%;background-color: #f2f2f0;">
				<div class="row" style="background-color: #f2f2f0;margin-left: 20px">
					<div class="col-lg-12 ">
							<br>
							<h2 style="color: #e97d12"><b>Using SAHAA.ME to find businesses by locations</b></h2>
							<br>
							<p style="font-size: 18px;color: black">
								<b style="font-size: 18px;color: #e97d12;">What areas can be recognized by SAHAA.ME?</b>
								<br><br>
							SAHAA.ME can be searched for the following terms:<br>
							<li>Search by region, town or country name, e.g. Al Lisaili, Dubai, Al Manama, Ajman, Al Mirfa, Abu Dhabi</li>
							<li>If you don't specify a location, SAHAA.ME will look for results across the UAE.</li>
							<li>You can also search most popular tourist destinations in the area e.g. Burj Al Arab, Dubai Mall etc.</li>
							<li>You can also search unitary administrations in country.</li><br>
							<b style="font-size: 18px;color: #e97d12;">I can't find the address I'm looking for on SAHAA.ME.</b>
							<br><br>
							To find the exact information you need:<br>
							<li>Make sure you've spelled everything correctly.</li>
							<li>Make an effort to reduce your location to three or more letters, followed by an *. There are a number of places that come up if you search for Burj*, such as Burj Khalifa, Burj Al Arab and Burj Al Swat.</li>
							<li>You can also search by Makani number in emirates.</li><br>
							<b style="font-size: 18px;color: #e97d12;">How can I find a map of the location of a business?</b>
							<br><br>
							You can get driving directions to a company's location if their address is published. Clicking on the map in the upper right-hand corner of the search results page to see where you are searching. To see a map of the location, go to the business listing page and select the 'Map & Directions' tab.<br><br>
							<b style="font-size: 18px;color: #e97d12;">What are the locations of popular businesses in my area?</b>
							<br><br>
							You can find our most-searched cities and most searched businesses as SAHAA.ME offers personalized local homepages for each of those locations.<br><br>
