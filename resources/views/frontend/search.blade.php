		...
		<div class="col-lg-9 col-md-9 col-sm-12  mobile-order-01 mobile-margin-bottom" style="">
			<div class="container" style="height: 100%;background-color: #f2f2f0;">
				<div class="row" style="background-color: #f2f2f0;margin-left: 20px">
					<div class="col-lg-12 ">
							<br>
							<h2 style="color: #e97d12"><b>Searching on SAHAA.ME</b></h2>
							<br>
							<p style="font-size: 18px;color: black">
								Find out how your results are arranged, how to get in touch with the businesses, and which results show up in your search results. Using our step-by-step instructions, you can easily navigate SAHAA.ME's search results pages, business listings, and company details. <br><br>
								<b style="font-size: 18px;color: #e97d12;">What results do I get when I type in my query?</b>
								<br><br>
								Companies that are either based in or provide services to your location appear first in the search results. More matches appear as you scroll down the page, even if they may not be located in your search area, but they still serve your area.<br><br>
								Select the 'Sort By' drop-down option at the top of the results to modify the order of your results. Here, you can select to sort by distance from your current location, the service region the business services, the star rating, or the most reviewed businesses.<br><br>
								<b style="font-size: 18px;color: #e97d12;">Which buttons are included in company results& they can be used?</b>
								<br><br>
								...
								<li>You can directly visit the company's website by simply clicking on the "Website" link next to its name.</li>
								<li>Directly contact the company by clicking the "Email" button.</li>
								<li>To make a phone call from your cell phone, simply click on the phone number.</li><br>
								<p style="font-size: 18px;color: black">
									You can also visit business's profile page created on SAHAA.ME when you click on a business name, where you'll be able to see images, videos, reviews, and more.<br><br>
									<b style="font-size: 18px;color: #e97d12;">What about the sequence of my search results?</b>
								<br><br>
