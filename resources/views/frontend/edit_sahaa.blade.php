		...
		<div class="col-lg-9 col-md-9 col-sm-12  mobile-order-01 mobile-margin-bottom" style="">
			<div class="container" style="height: 100%;background-color: #f2f2f0;">
				<div class="row" style="background-color: #f2f2f0;margin-left: 20px">
					<div class="col-lg-12 ">
							<br>
							<h2 style="color: #e97d12"><b>Edit my business listing on Sahaa.me</b></h2>
							<br>
							<p style="font-size: 18px;color: black">
								Editing the content on your Sahaa.me business listing is simple with our self-service tools. Take control of your listing content to make sure your business information is always kept fresh and up to date. <br><br>
								You can update the content of your Sahaa business listing via the sahaa for Business app or your online sahaa account.
								<br><br>
								You can update the content of your Sahaa business listing via the sahaa for Business app or your online Sahaa account.<br><br>
								<b style="color: #e97d12">Sahaa for Business app</b>
									<li>
										Tap <a href="" style="color: blue">here</a> to download or launch the free sahaa for Business app
									</li>
									<li>
										Tap on <b>Manage profile</b> on the main app screen 
									</li>
									<li>
								...
								<br><br>
								<b style="font-size: 18px;color: #e97d12;">Online Sahaa account dashboard</b>
									<li>
										Log in to your <a href="" style="color: blue">sahaa</a> account 
									</li>
									<li>
										Select <b>Manage your profile page</b>
									</li>
									<li>
										If you have multiple business listings with Sahaa, then you will be prompted to select which listing to edit  
									</li>
									<li>
										Select from the <b>Profile summary</b> the content you wish to update
									</li>
