			...
			<div class="container" style="height: 100%;background-color: #f2f2f0;">
				<div class="row" style="background-color: #f2f2f0;margin-left: 20px">
					<div class="col-lg-12 " style="margin-bottom: 60px">
							<br>
							<h2 style="color: #e97d12"><b>Claim your Business on SAHAA.ME</b></h2>
							<br>
							<p style="font-size: 18px;color: black">
								Claiming your business on SAHAA.ME is an option if your business is already listed. Register your business listing so you can make changes to your profile page, which will make it easier for customers to locate you.<br><br>
