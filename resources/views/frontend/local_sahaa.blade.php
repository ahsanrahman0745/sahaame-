		...
		<div class="col-lg-9 col-md-9 col-sm-12  mobile-order-01 mobile-margin-bottom" style="">
			<div class="container" style="height: 100%;background-color: #f2f2f0;">
				<div class="row" style="background-color: #f2f2f0;margin-left: 20px">
					<div class="col-lg-12 ">
							<br>
							<h2 style="color: #e97d12"><b>Using SAHAA.ME to find local businesses </b></h2>
							<br>
							<p style="font-size: 18px;color: black">
								<b style="color: #e97d12">What type of information can I get on SAHAA.ME?</b>
								<br><br>
								...
								<b style="color: #e97d12">How do I find out the name of a specific company?</b>
								<br>
								<li>In the first search box ('Fast food', ‘Decoration’ or 'courier'), simply enter the name of the company you're looking for.</li><br>
								The majority of business listed on SAHAA.ME may be found through our auto-suggest tool, which is available to all users. Once you begin typing, our search engine will recommend one of these matches.<br><br>
								<p style="font-size: 18px;color: black">
									<b style="color: #e97d12">What key words should I use in my search?</b>
								<br><br>
								...
								<li>Any misspellings can be corrected automatically by the search engine.</li>
								<li>If you're not sure how to format your search, the auto-suggest option can be helpful.</li>
								<li>For example, it knows that '24hr' and '24 hour' are synonymous. </li><br>
								Also search engines like Google and Bing can understand searches like these by using commas and spaces to separate words:<br><br>Pizza, hospital <br><br>
								<b style="font-size: 18px;color: #e97d12;">I can't find the information I'm looking for</b>
								<br><br>
								If SAHAA.ME search box can't find what you're looking for, there are a few ways to try:<br>
								<li>Use quotation marks in your search, such as '24hr live'. We'll use our search engine to look for an exact phrase match to what you've typed in.</li>
								<li>Enter your search query, followed by *, and see if it helps. Everything that begins with your search query will be displayed here.</li>
								<li>Changing the location where you're looking can also help.</li><br>
								<b style="font-size: 18px;color: #e97d12;">Is there a chronological list of categories available on SAHAA.ME?</b>
								<br><br>
								Here is Sahaa's chronological <a href="" style="color: blue">list of categories</a>.
