			...
			<div class="container" style="height: 100%;background-color: #f2f2f0;">
				<div class="row" style="background-color: #f2f2f0;margin-left: 20px">
					<div class="col-lg-12 " style="margin-bottom: 60px">
							<br>
							<h2 style="color: #e97d12"><b>Can I claim my Business listing on Sahaa Business app?</b></h2>
							<br>
							<p style="font-size: 18px;color: black">
								Find your business on the login screen by clicking the ‘Find your Business’ button. You can take control of your business directory on SAHAA.ME.<br><br>
								Your business names and postal codes will be required to find your business. Using the information you've provided, we will look for existing company listings that fit your search criteria or give you the option to add a new listing entirely.<br><br><br><br>

					</div>
					<div class="col-lg-12 " style="float: right;position: absolute;bottom: 0;right: 0">
