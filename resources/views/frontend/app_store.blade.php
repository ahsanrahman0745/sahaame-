...
<body>
        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <a href="index.html" class="logo">
              <img src="{{ asset('fontend/assets/images/logo.png')}}" alt="Chain App Dev">
            </a>
            <!-- ***** Logo End ***** -->
            <!-- ***** Menu Start ***** -->
            <ul class="nav">
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class="right-image wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                <img src="{{ asset('fontend/assets/images/slider-dec.png')}}" alt="">
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-lg-8 offset-lg-2">
          <div class="section-heading  wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.5s">
            ...
            <img src="{{ asset('fontend/assets/images/heading-line-dec.png')}}" alt="">
      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          <div class="right-image">
            <img src="{{ asset('fontend/assets/images/about-right-dec.png')}}" alt="">
          </div>
        </div>
      </div>
    </div>
                          ...
                          <div class="row">
                            <div class="col-lg-12">
                              <div class="client-content">
                                <img src="{{ asset('fontend/assets/images/quote.png')}}" alt="">
                                <p>“Lorem ipsum dolor sit amet, consectetur adpiscing elit, sed do eismod tempor idunte ut labore et dolore magna aliqua darwin kengan
                                  lorem ipsum dolor sit amet, consectetur picing elit massive big blasta.”</p>
                              </div>
                              <div class="down-content">
                                <img src="{{ asset('fontend/assets/images/client-image.jpg')}}" alt="">
      ...
      <div class="row">
        ...
        <div class="col-lg-4">
          <div class="pricing-item-regular">
            ...
            <div class="icon">
              <img src="{{ asset('fontend/assets/images/pricing-table-01.png') }}" alt="">
            </div>
            <ul>
  ...
  <script src="{{ asset('fontend/assets/js/popup.js')}}"></script>
